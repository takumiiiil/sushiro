...
class MakeButton:UIButton,selection{
    ...
    @objc func selection(sender: UIButton) {}
        ...
        func make(x:CGFloat,y:CGFloat,width:CGFloat,height:CGFloat,back:UIColor,tag:Int,
                  ...
                  _text:String="",_textColer:UIColor=UIColor.black,_fontSize:CGFloat=30,_adjustsFontSizeToFitWidth:Bool=true,_alignment:NSTextAlignment=NSTextAlignment.center,_font:String = "Bold",view:AnyObject){
